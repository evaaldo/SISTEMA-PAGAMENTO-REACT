            ...
            <div className="preco-desktop" id='preco'>
                ...
                <div className='preco-desktop-cards'>
                    <div className='preco-desktop-card'>
                        ...
                        <Link className='preco-desktop-card__botaao' to='/PagamentoCabeloBarba'>Adquirir já o pacote!</Link>
                    </div>
                    <div className='preco-desktop-card-popular'>
                        <h4 className='preco-desktop-card__titulo'>Corte</h4>
                        <div className='preco-desktop-card__preco-mes'>
                            <h1 className='preco-desktop-card__preco'>R$ 45,00</h1>
                            <h4 className='preco-desktop-card__mes'>/Mês</h4>
                        </div>
                        <p className='preco-desktop-card__popular'>Pacote popular</p>
                        <h4 className='preco-desktop-card__descricao'>Corte de cabelo garantido durante todo o mês.</h4>
                        <Link className='preco-desktop-card__botaao' to='/PagamentoCabelo'>Adquirir já o pacote!</Link>            
                    </div>
                    <div className='preco-desktop-card'>
                        ...
                        <Link className='preco-desktop-card__botaao' to='/PagamentoBarba'>Adquirir já o pacote!</Link>
                    </div>
                </div>
